...
contract XecureTransAction is StandardToken { // CHANGE THIS. Update the contract name. Endret til XecureTransAction
    ...
    */
    ...
    // How many decimals to show. To be standard complicant keep it 18
    string public symbol;                 
    // An identifier: eg SBX, XPR etc..
    string public version = "XTA1.0"; 
    uint256 public unitsOneEthCanBuy;     
    // How many units of your coin can be bought by 1 ETH?
    uint256 public totalEthInWei;         
    // WEI is the smallest unit of ETH (the equivalent of cent in USD or satoshi in BTC). 
    ...
    function XecureTransAction() public {
        balances[msg.sender] = 100000000000000000000000000;          
        // 100 000 000 Tokens (XTA) Give the creator all initial tokens. This is set to 1000 for example. 
        // If you want your initial tokens to be X and your decimal is 5, set this value to X * 100000. (CHANGE THIS)
        totalSupply = 100000000000000000000000000;                   
        // Satt til 100 000 000. Update total supply (1000 for example) (CHANGE THIS)
        name = "XecureTransAction";                                   
        ...
        // 1 ETH = 1000 XTA (ca. 0,85 USD) Set the price of your token for the ICO (CHANGE THIS)
